Public Class Title_one
    ...
    Public Function Set_format(ByVal style As Word.Style, ByVal paragreph As Word.ParagraphFormat, ByVal wd As Word.Application)
        ...
        With title_one_format
            ...
            'MsgBox TypeName(listtemplate)
            'MsgBox TypeName(lt.ListLevels(1))
            .LinkToListTemplate(ListTemplate:=list_template.lt)
            With .Font
                .NameFarEast = "宋体"     ' 字体
                .NameAscii = "宋体"       ' 字体
                .NameOther = "宋体"       ' 字体
        ...
        'MsgBox("title_one_object.paragreph_format.LineSpacingRule " & paragreph_format.LineSpacingRule)
        'MsgBox("Microsoft.Office.Interop.Word.WdLineSpacing.wdLineSpaceSingle " & Microsoft.Office.Interop.Word.WdLineSpacing.wdLineSpaceSingle)
        With paragreph_format
            ...
            'MsgBox(".LineSpacingRule " & .LineSpacingRule)
            ...
            .OutlineLevel = Microsoft.Office.Interop.Word.WdOutlineLevel.wdOutlineLevel1     ' 大纲级别
